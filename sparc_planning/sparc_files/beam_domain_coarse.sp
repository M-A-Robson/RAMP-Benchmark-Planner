...
holds(can_fasten_c(B1,B2), true, I+1) :- occurs(assemble(R,B1), I), holds(in_assembly_c(B2), true, I), not fits_into_c(B1,B2), B1!=B2.
holds(can_fasten_c(B1,B2), true, I+1) :- occurs(assemble(R,B1), I), holds(in_assembly_c(B2), true, I), not fits_through_c(B1,B2), B1!=B2.
...
-occurs(push(R,B1), I) :- holds(in_hand_c(T), true, I), #thing(T).
