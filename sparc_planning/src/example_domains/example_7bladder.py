...
def generate_domain_setup() -> Tuple[List[str], List[str], List[str],List[str]]:
    ...
    coarse_fluents = [
        ...
        'holds(loc_c(p7,input_area),true,0).',
        'holds(loc_c(p8,input_area),true,0).',
        'holds(loc_c(p9,input_area),true,0).',
        'holds(loc_c(p10,input_area),true,0).',
        ...
        'holds(in_hand_c(rob0,p7),false,0).',
        'holds(in_hand_c(rob0,p8),false,0).',
        'holds(in_hand_c(rob0,p9),false,0).',
        'holds(in_hand_c(rob0,p10),false,0).',
    ]
    coarse_statics = [
    ...
    fine_fluents = coarse_fluents + [
        ...
        'holds(loc_f(p7,p7i),true,0).',
        'holds(loc_f(p8,p8i),true,0).',
        'holds(loc_f(p9,p9i),true,0).',
        'holds(loc_f(p10,p10i),true,0).',
        ...
        'holds(in_hand_f(rob0,p7),false,0).',
        'holds(in_hand_f(rob0,p8),false,0).',
        'holds(in_hand_f(rob0,p9),false,0).',
        'holds(in_hand_f(rob0,p10),false,0).',
        ...
        'holds(in_hand_f(rob0,b2j1),false,0).',
        'holds(in_hand_f(rob0,b2j2),false,0).',
        'holds(in_hand_f(rob0,b2j3),false,0).',
        'holds(in_hand_f(rob0,b2l1),false,0).',
        'holds(in_hand_f(rob0,b2l2),false,0).',
